...
export default function WellnessPage() {
  return (
    <main className="min-h-screen bg-[#FAF9F6]">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 px-4" style={{ background: 'linear-gradient(180deg, #4A90A4 0%, #6AACBE 50%, #FAF9F6 100%)' }}>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-[#4A90A4] to-[#6B9080]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-white/80 mb-8">
            Download the free app. Scan your supplements. Find verified practitioners.
          </p>
