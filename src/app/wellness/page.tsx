        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            ...
            <div className="group bg-white rounded-2xl p-5 sm:p-8 border-2 border-gray-200 hover:border-gray-300 hover:shadow-lg transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Book Instantly, Anytime</h3>
              <p className="text-gray-600 mb-6 leading-relaxed">Schedule appointments 24/7 with real-time availability</p>
              <ul className="space-y-3">
                {[
            ...
            <div className="group bg-white rounded-2xl p-5 sm:p-8 border-2 border-gray-200 hover:border-gray-300 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">Message your practitioners with complete privacy</p>
              <ul className="space-y-3">
                {[
            ...
            <div className="group bg-white rounded-2xl p-5 sm:p-8 border-2 border-gray-200 hover:border-gray-300 hover:shadow-lg transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Safety & Trust Guaranteed</h3>
              <p className="text-gray-600 mb-6 leading-relaxed">Every practitioner meets our rigorous standards</p>
              <ul className="space-y-3">
                {[
